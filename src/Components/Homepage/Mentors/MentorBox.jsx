    ...
    return(
        <div className="bg-putih text-center shadow rounded relative">
            <div className="group">
                ...
                <div className="w-full p-4 h-full rounded top-0 opacity-0 transition duration-500 hover:opacity-90 bg-putih absolute text-justify text-sm md:text-lg text-ungu-400">
