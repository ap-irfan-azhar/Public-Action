                        ...
                        <div className="pb-20 relative z-10">
                            <div className="md:flex items-center md:my-5 md:mt-8 mt-20 mb-20">
                                ...
                                <div className=" m-5 text-ungu-300">
                                        <p className="text-4xl font-serif font-bold md:text-left text-center">Public Action Conference</p>
                            ...
                            <div className="md:flex items-center md:my-5 md:mb-8 mb-20">
                                ...
                                <div className=" m-5 text-ungu-300">
                                        <p className="text-4xl font-serif font-bold md:text-right text-center">AIPC Conference</p>
